...
SECRET_KEY = "django-insecure-5l7jogd8l#g+0y)b_ahffum0_39t#p#od-)wi@3*%kq^)ax#o$"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
# se usa para poner los dominios
ALLOWED_HOSTS = []


# Application definition
# aqui es donde pondremos las distintas apps
